      ...
      var markupAfterInput = function () {
        ...
        if (useTabs) {
          ...
          if (settings.showSavedColors) {
            $tabContainer.append($("<span>").addClass(savedColorsClass).append($("<a>").text("Guardados")));
          }
      ...
      var methods = {
        ...
        calculateHighlightedColor: function () {
          ...
          if (tab === "basic") {
            ...
            //OSCAR$thisParent.prev('.color-label').replaceWith(
            //OSCAR  '<button class="color-select btn btn-mini" type="button">Select</button>');
